    ...
    <div class="container team" style="padding: 0">
        <div class="team-row" style="padding: 0">
            <div class="member">
                ...
                <a href="https://twitter.com/chosenfate_dx" target="_blank"><i class="fab fa-twitter" style="color: var(--main); font-size: 30px; margin-right: 10px; margin-left: 10px;" aria-hidden="true"></i></a>
