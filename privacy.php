...
<div class="notnavtext" id="section1">
    <h1 class="fs-1 text-end" style="padding-top: 5%">Privacy Policy</h1>
    <p style="font-weight: bold" class="sectionstart">Last updated February 7 2022</p>
...
<div class="notnavtext textend" id="how">
    ...
    <div class="sectionstart">
        ...
        <p>The data collected by Google Analytics within the PsychOps website is collected as soon as the user enters the website, and is sent to the Google Analytics panel that is accessible only to the PsychOps owner ("Joshua Slui").</p>
    </div>
</div>
