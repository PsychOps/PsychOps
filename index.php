...
<div class="container text-center">
    ...
    <p>
        PsychOps Studios is an organization based in the Netherlands owned by <a href="https://zoniq.tk" target="_blank">Joshua</a> and <a href="https://hilex23.tk/" target="_blank">Manuel</a> dedicated to open-source software and web development with <b>5</b> developers, including the owners. With user experience and feedback in mind, PsychOps Studios always attempts to provide its users with products that are to their liking.
    ...
    <a href="https://discord.gg/QMhvHuGPMx" target="_blank" class="btn bg-green btn-rounded"><span><i class="fab fa-discord" aria-hidden="true"></i></span> Join our Discord</a>
</div>
